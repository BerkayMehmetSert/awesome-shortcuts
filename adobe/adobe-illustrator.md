...
[🌐 Official Site](https://www.adobe.com/products/illustrator.html)
...
| Switch Pencil tool to Smooth tool                                                          | `Alt`                           |
...
| Select noncontiguous actions, brushes, layers (same level only), links, styles, or swatches | `Ctrl-click`               |
